...
func (h *Quic) Dial(network, addr string) (net.Conn, error) {
	...
	if err != nil {
		log.Printf("%T.RoundTripOpt(%#v) error: %+v", h.transport, req.URL.String(), err)
		h.transport.Close()
...
func (s *QuicStream) LocalAddr() net.Addr  { return nil }
func (s *QuicStream) RemoteAddr() net.Addr { return nil }
